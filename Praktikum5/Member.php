...
<body>
  ...
  <center><a href="FromMember.php"><button type="button" class="btn btn-dark btn-sm">Tambah Data Baru</button></a></center>
    ...
    <table class="table table-striped align-middle">
      ...
      while ($data = mysqli_fetch_array($result)) { ?>
        <tr>
          ...
          <td style="text-align: center;"><a href="FromMember.php?id_member=<?php echo $data['id_member']; ?>"><button class="btn btn-primary btn-sm">Edit</button></a></td>
