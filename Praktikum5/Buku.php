...
<body>
  ...
  <center><a href="FromBuku.php"><button type="button" class="btn btn-sm btn-dark">Tambah Data Baru</button></a></center>
    ...
    <table class="table table-striped align-middle">
      ...
      while ($data = mysqli_fetch_array($result)) { ?>
        <tr>
          ...
          <td style="text-align: center;"><a href="FromBuku.php?id_buku=<?php echo $data['id_buku']; ?>"><button class="btn btn-primary btn-sm">Edit</button></a></td>
