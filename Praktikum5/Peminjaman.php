...
<body>
  ...
  <center><a href="FromPeminjaman.php"><button type="button" class="btn btn-dark btn-sm">Tambah Data Baru</button></a></center>
    ...
    <table class="table table-striped align-middle">
      ...
      while ($data = mysqli_fetch_array($result)) { ?>
        <tr>
          ...
          <td style="text-align: center;"><a href="FromPeminjaman.php?id_peminjaman=<?php echo $data['id_peminjaman']; ?>"><button class="btn btn-primary btn-sm">Edit</button></a></td>
